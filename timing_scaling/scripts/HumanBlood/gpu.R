...
saveRDS(devil.final.res, paste0("results/HumanBlood/fits/gpu_devil_", n_genes, "_ngene_", n_cells, "_ncells_", N_CELL_TYPES, "_celltypes.rds"))
...
saveRDS(devil.final.res, paste0("results/HumanBlood/fits/gpu_devilS_", n_genes, "_ngene_", n_cells, "_ncells_", N_CELL_TYPES, "_celltypes.rds"))
...
for (n_genes in c(100, 1000, 5000)) {
  ...
  for (n_cells in c(1000, 100000, 1e6)) {
    ...
    res_name = paste0("results/HumanBlood/gpu_devil_", n_genes, "_ngene_", n_cells, "_ncells_", N_CELL_TYPES, "_celltypes.rds")
