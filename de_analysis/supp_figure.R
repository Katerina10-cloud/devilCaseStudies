...
null_plots_cellwise <- all_null_plots(author, FALSE, algos = method_cellwise)
pow_plots_cellwise <- all_pow_plots(author, FALSE, algos = method_cellwise)
null_plots_pwise <- all_null_plots(author, TRUE, method_patientwise)
pow_plots_pwise <- all_pow_plots(author, TRUE, method_patientwise)
